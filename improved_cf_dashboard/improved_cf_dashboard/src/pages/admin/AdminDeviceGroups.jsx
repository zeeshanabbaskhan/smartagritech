...
import { Boxes, Plus, Edit2, Trash2, Cpu, Users } from 'lucide-react'
...
const EMPTY_FORM = { name: '', description: '', org: '', deviceIds: [], userIds: [] }
...
export default function AdminDeviceGroups() {
  const { deviceGroups, createDeviceGroup, updateDeviceGroup, deleteDeviceGroup } = useDeviceGroups()
  ...
  // Devices/Users available for the org selected in the form
  ...
  const deleteTarget = deviceGroups.find(g => g.id === deleteId)
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-surface-400 mt-0.5">
              Group related devices across any organization — e.g. all washing machines, all boilers, or any custom set
            </p>
          </div>
        </div>
        <button
