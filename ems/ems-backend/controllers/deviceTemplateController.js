        ...
        for (const variable of slave.variables) {
          await tx.deviceTemplateVariable.create({
            data: {
              ...
              sortNumber:           variable.sortNumber,
              identifier:           variable.identifier,
              machineId:            variable.machineId,
              machineControl:       variable.machineControl,
              iconLabel:            variable.iconLabel,
              lineChartColor:       variable.lineChartColor,
              lineChartLimit:       variable.lineChartLimit,
              lowLimitLineChart:    variable.lowLimitLineChart,
              peakTimeStart:        variable.peakTimeStart,
              peakTimeEnd:          variable.peakTimeEnd,
              peakOffTimeStart:     variable.peakOffTimeStart,
              peakOffTimeEnd:       variable.peakOffTimeEnd,
              peakTimeColor:        variable.peakTimeColor,
              peakOffTimeColor:     variable.peakOffTimeColor,
              variableType:         variable.variableType,
              registerFuncCode:     variable.registerFuncCode,
              dataFormat:           variable.dataFormat,
              numberFormat:         variable.numberFormat,
              decimalPlacesPadding: variable.decimalPlacesPadding,
              storageVariable:      variable.storageVariable,
              storageTiming:        variable.storageTiming,
              readWrite:            variable.readWrite,
              acquisitionFormula:   variable.acquisitionFormula,
              controlFormula:       variable.controlFormula,
              mainPageSelection:    variable.mainPageSelection,
              sortOrder:            variable.sortOrder,
              defaultUnitSelection: variable.defaultUnitSelection,
              equationSlaveIds:     variable.equationSlaveIds ?? undefined,
            },
          })
        }
      }
